...
def trainBEASTNet(nLastFile, pklName, csvName, csvNameFinal, logName, probs0, probs1, probs2, probs3, probs4, BEV, b,nIterations=100):
    """
    ...
    it print the parameters values  every 10 games in the log file and here (so the final values will be at the end of the file)
    and at the end creates a csv file (named by th param csvNameFinal) with the prediction of the tuned BEAST in a column named 'NEURAL_BEAST'
    """
    ...
    if nLastFile != 100:
        df2 = df2.append(pd.read_pickle(pklName + '_' + nLastFile + '.pkl'))
    else:
...
if __name__ == '__main__':
    #preprocess(csvName='tmp', pklName='tmp')
    """
    ...
    """
    trainBEASTNet(nLastFile=100, pklName='tmp', csvName='tmp', csvNameFinal='tmp2', logName='tmp',
               probs0=[2.1, 1.0, 1.0, 1.0], probs1=[2.7, 1.0, 1.0, 1.0], probs2=[2.85, 1.0, 1.0, 1.0],
               probs3=[2.95, 1.0, 1.0, 1.0], probs4=[3.05, 1.0, 1.0, 1.0], BEV=0.3, b=0.2)
    """
